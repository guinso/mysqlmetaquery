...
func (meta *MySQLMetaQuery) GetTableDefinition(db rdbmstool.DbHandlerProxy, dbName string,
...
func (meta *MySQLMetaQuery) GetTableNames(db rdbmstool.DbHandlerProxy, databaseName string, tableNamePattern string) ([]string, error) {
